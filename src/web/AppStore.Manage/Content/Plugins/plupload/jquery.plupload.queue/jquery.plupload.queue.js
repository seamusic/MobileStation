					...
					'<div class="plupload">' +
						'<div class="plupload_header">' +
							'<div class="plupload_header_content">' +
								...
								'<div class="plupload_header_text">' + _('请添加需要上传的文件') + '</div>' +
							'</div>' +
						'</div>' +
            ...
            this.each(function () {
                ...
                function updateList() {
                    ...
                    $.each(uploader.files, function (i, file) {
                        inputHTML = '';
                        var actionHTML = '<a href="#"></a>';

                        if (file.status == plupload.DONE) {
                            var actionHTML = '<a href="#"></a><i class="icon_delete"></i>';
                        ...
                        fileList.append(
							'<li id="' + file.id + '">' +
								...
								'<div class="plupload_file_action">' + actionHTML + '</div>' +
                        ...
                        $('#' + file.id + ' i.icon_delete').click(function (e) {
                            if (confirm("该文件[" + file.name + "]已上传，确定要删除吗？")) {
                                $('#' + file.id).remove();
                                uploader.removeFile(file);
                            }
